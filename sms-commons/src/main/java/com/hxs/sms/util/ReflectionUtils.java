...
public class ReflectionUtils {
    ...
    public static Object getFieldValue(final Object object,
        ...
        try {
            ...
            LoggerUtil.error(ReflectionUtils.class, "不可能抛出的异常{}" + e.getMessage());
        }
        return result;
    }
    ...
    public static Class getSuperClassGenricType(final Class clazz,
        ...
        if (!(genType instanceof ParameterizedType)) {
            LoggerUtil.warn(clazz.getClass(), clazz.getSimpleName() + "'s superclass not ParameterizedType");
            return Object.class;
        }
        ...
        if (index >= params.length || index < 0) {
            LoggerUtil.warn(clazz.getClass(), "Index: " + index + ", Size of "
                    + clazz.getSimpleName() + "'s Parameterized Type: "
                    + params.length);
            return Object.class;
        }
        if (!(params[index] instanceof Class)) {
            LoggerUtil.warn(clazz.getClass(),
    ...
    public static void copyPorperties(Object dest, Object source,
        ...
        for (String por : porperties) {
            ...
            LoggerUtil.debug(ReflectionUtils.class, "属性名：" + por + "------------- 属性值：" + srcObj);
            if (srcObj != null) {
                try {
